    ...
    UUPSUpgradeable
{
    ...
    address public biconomyTrustedForwarder;
    ...
    function initialize(address _biconomyTrustedForwarder) public initializer {
        __ReentrancyGuard_init();
        __UUPSUpgradeable_init();
        AconomyERC2771Context_init(_biconomyTrustedForwarder);
        biconomyTrustedForwarder = _biconomyTrustedForwarder; // Set Biconomy's trusted forwarder
